...
choices are preferred where options arise.
{
    ...
    },
    {
      ...
      "_type": "evaluation_report",
      "_version": "v1.0.0",
      "_symbolic_id": "pdp-0001c-final-selection",
      "_title": "PDP-0001c Final Selection Report",
      "_subtitle": "Final ranking of candidates based on symbolic resonance, fidelity, and penalties.",
      "_status": "ACTIVE",
      "_license": "MIT",
      "_language": "json",
      "_authors": [
      ...
      "comments": [
        "After final evaluation, GPT-5 Run A has been selected as the top candidate due to its higher symbolic resonance and final score.",
        "Gemini Run C, while strong, falls behind due to higher penalties and lower symbolic resonance."
      ]
    },
    {
      "_schema": "noor-header-v1",
